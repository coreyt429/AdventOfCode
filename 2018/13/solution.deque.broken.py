...
class Carts:
    ...
    def add_cart(self, pos, direction):
        ...
        """
        self.carts.append(Cart(pos, direction, self.grid, self.carts))
    ...
    def sort(self):
        ...
        """
        self.carts = deque(sorted([cart for cart in self.carts if not cart.removed]))
